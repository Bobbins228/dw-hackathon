...
processed_datasets = dataset_preparation()
train_ds_size = processed_datasets["train"].count()
steps_per_epoch = 100 #train_ds_size // (batch_size * num_workers)
...
trainer = TorchTrainer(
    ...
    run_config=RunConfig(storage_path=storage_path, name="gpt-example"),
)
results = trainer.fit()
